    ...
    <div className='page4 relative w-full flex flex-col h-[80vh] md:h-[60vh] lg:h-[90vh] '>
        ...
        <div className='w-full cursor-pointer h-[60vh] xl:h-[65vh] md:h-[45vh] lg:h-[70vh] absolute top-[50%] translate-y-[-50%] left-0 px-[25px] xl:px-[100px]'>
            ...
            <div className='absolute text-[25px] md:text-[35px] top-0 py-[15px] md:py-[25px] lg:py-[55px] lg:text-[45px] lg:px-[30px] px-[10px] flex flex-col items-start'>
              <h1 className={`${isClick ? 'bg-white' : 'bg-[#0E0F11]'} inline-block px-[15px] py-[10px] pt-[15px] leading-[.7] rounded-t-[15px]`}>" Shape created</h1>
              <h1 className={`${isClick ? 'bg-white' : 'bg-[#0E0F11]'} -mt-1 border-[#0E0F11] inline-block px-[15px] py-[10px] leading-[.7] rounded-r-[15px]`}>something better than I ever</h1>
              <h1 className={`${isClick ? 'bg-white' : 'bg-[#0E0F11]'} -mt-1 inline-block px-[15px] py-[10px] leading-[.7] rounded-br-[15px]`}>could have imagined</h1>
